...
function generateFreemapStyle(
  ...
  return createMap({
    ...
    .style('landcover')
      ...
      .area(colors.scrub, 'vineyard') // TODO use different color/pattern for vineyard
      ...
      .typesRule('scree')
        .borderedPolygonSymbolizer(hsl(0, 0, 80))
    ...
    .style('water_line')
      .typesRule('river')
        .lineSymbolizer({ stroke: colors.water, strokeWidth: 2.2, strokeOpacity: '1 - [tunnel] / 0.6' })
      .rule({ filter: "[type] <> 'river'", minZoom: 12 })
        .lineSymbolizer({ stroke: colors.water, strokeWidth: 1.2, strokeOpacity: '1 - [tunnel] / 0.6' })
    .style('barrierways')
      .rule({ minZoom: 16 })
